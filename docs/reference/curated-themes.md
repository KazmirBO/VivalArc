...
1.	Click on the theme name to go to its page. If a theme name is not clickable, it means the theme is still under review, and you can [use the local version instead](../guides/using-local-vivaldi-theme.md).
